...
exports.createPages = async function createPages({ graphql, boundActionCreators }) {
...
exports.onCreateNode = function onCreateNode({ node, boundActionCreators, getNode }) {
  ...
  if (node.internal.type === 'MarkdownRemark') {
    ...
    if (type.includes('Proposal')) {
      ...
      createNodeField({ node, name: 'slug', value: `/proposals/${year}/${slugify(node.frontmatter.title)}` });
